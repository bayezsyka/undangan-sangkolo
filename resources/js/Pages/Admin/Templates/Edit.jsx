...
export default function Edit({ auth, template }) {
    ...
    return (
        <AuthenticatedLayout user={auth.user}>
            ...
            <PageHeader 
                title="Edit Template" 
                subtitle={`Memperbarui detail dan setelan default untuk ${template.name}`}
                actions={
            ...
            <div className="max-w-4xl">
                <form onSubmit={submit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 space-y-8">
                        <SectionCard title="Identitas Template" description="Sesuaikan nama dan rincian identitas katalog.">
                    ...
                    <div className="space-y-8">
                        <SectionCard title="Setelan Default">
                            <div className="space-y-6">
                                ...
                                >
                                    {processing ? 'Menyimpan...' : 'Perbarui Template'}
                                </button>
                            </div>
                        </SectionCard>
                    </div>
